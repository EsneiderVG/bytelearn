    ...
    <div class="wrapper py-10 px-6">
        <div class="flex items-center gap-4 mb-4 justify-between">
            ...
            <div class="flex items-center gap-4">
                <h1 class="boxy-lxl"><c:out value="${keyboard.name}"/></h1>
                <div>
            ...
            <div class="flex justify-between items-align ">
                <ol class="relative border-l border-gray-200 dark:border-gray-700 text-black pb-5 mt-5">              
                    <li class="mb-10 ml-6">            
                        ...
                        <div class="flex justify-between gap-4">
                            <div class="max-w-[560px]">
                                <h3 class="flex items-center mb-1 text-lg font-semibold text-black ml-2">Flowbite Application UI v2.0.0 <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">Latest</span></h3>
                    ...
                    <li class="mb-10 ml-6">
                        ...
                        <div class="flex justify-between gap-4">
                            <div class="max-w-[560px]">
                                <h3 class="mb-1 text-lg font-semibold text-black ml-2">Flowbite Figma v1.3.0</h3>
                    ...
                    <li class="mb-6 ml-6">
                        ...
                        <div class="flex justify-between gap-4">
                            <div class="max-w-[560px]">
                                <h3 class="mb-1 text-lg font-semibold text-black ml-2">Flowbite Library v1.2.2</h3>
