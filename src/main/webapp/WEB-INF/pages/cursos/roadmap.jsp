...
<body>
    ...
    <div class="container mx-auto my-8">
        <div class="flex items-center gap-6">
            <h1 style="border: 2px solid white; padding: 10px 10px; font-size: 32px;">Basic</h1>
            <div>
        ...
        <div class="flex justify-between items-align">
            <ol class="relative border-l border-gray-200 dark:border-gray-700 text-white pb-5 mt-5">              
                <li class="mb-10 ml-6">            
                    ...
                    <div class="flex justify-between">
                        <div class="max-w-[560px]">
                            ...
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500 ml-2">Released on January 13th, 2022</time>
                            <p class="mb-4 ml-2 ml-2 text-base font-normal text-gray-500 dark:text-gray-400">Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages.</p>
                ...
                <li class="mb-10 ml-6">
                    ...
                    <div class="flex justify-between">
                        <div class="max-w-[560px]">
                            ...
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500 ml-2">Released on December 7th, 2021</time>
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400 ml-2">All of the pages and components are first designed in Figma and we keep a parity between the two versions even as we update the project.</p>
                        </div>
                        <div class="flex-col">
                            <a href="#" class="block max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                <div class="flex gap-6">
                ...
                <li class="mb-10 ml-6">
                    ...
                    <div class="flex justify-between">
                        <div class="max-w-[560px]">
                            ...
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500 ml-2">Released on December 2nd, 2021</time>
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400 ml-2">Get started with dozens of web components and interactive elements built on top of Tailwind CSS.</p>
                        </div>
                        <div class="flex-col">
                            <a href="#" class="block max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                <div class="flex gap-6">
                ...
                <li class="mb-10 ml-6">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                        <i class="fa-solid fa-caret-up w-2.5 h-2.5 text-blue-800 dark:text-blue-300 mb-1" ></i>
                    </span>
                </li>
            </ol>
